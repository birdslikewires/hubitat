...
metadata {
	...
	definition (name: "Xiaomi Aqara Wireless Mini Switch WXKG11LM", namespace: "BirdsLikeWires", author: "Andrew Davison", importUrl: "https://raw.githubusercontent.com/birdslikewires/hubitat/master/xiaomi/drivers/xiaomi_aqara_wireless_mini_switch_wxkg11lm.groovy") {
		...
		fingerprint profileId: "0104", inClusters: "0000,FFFF,0006", outClusters: "0000,0004,FFFF", manufacturer: "LUMI", model: "lumi.sensor_switch.aq2", deviceJoinName: "Aqara Wireless Mini Switch", application: "03"
	...
	if (map.cluster == "0000") { 
		...
		if (map.attrId == "0005" || map.attrId == "FF01") {
			...
			if (map.attrId == "0005") {
				...
				// Scrounge more value! It's another button, so as these can quad-click we'll call this button 5.
